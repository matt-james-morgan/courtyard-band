  ...
  const statistics = [
    {
      ...
      description:
        "Number of early stage rounds is not growing in the Baltics since 2021",
    },
    {
      title: "Limited Ecosystem",
      description:
        "Total number of startups in Lithuania is stagnant for more than 5 years ~ 800",
    },
    {
      title: "Funding Inequality",
      description:
        "90% of VC funding still goes to repeat founders and traditional tech backgrounds",
    },
  ];
          ...
          <FadeIn delay={200}>
            <div className="relative">
              <div className="w-full h-[600px] overflow-hidden">
                <img
                  src="/lovable-uploads/IMG_9204.JPG"
