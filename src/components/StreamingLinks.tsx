...
const platforms = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
        <path d="M12.012 3.992L8.008 7.996 4.004 3.992 0 7.996l4.004 4.004 4.004-4.004 4.004 4.004 4.004-4.004L20.02 12l3.98-4.004-4.004-4.004-4.004 4.004-3.98-4.004zM8.008 12.008L4.004 16.012 0 12.008l4.004 4.004 4.004-4.004 4.004 4.004 4.004-4.004L20.02 16.012l3.98-4.004-4.004-4.004-4.004 4.004-3.98-4.004z" />
      </svg>
    ),
  },
  {
